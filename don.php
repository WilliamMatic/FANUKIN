...
<html lang="en">
    <head>
        ...
        <!-- Efinance Title -->
        <title>FANUKIN - Faire un don</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="irs-inner-heading">
                            ...
                            <p><a href="home">Accueil</a> > <a href="#">Faire un don</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row animatedParent animateOnce">
                    <p style="text-align: center;font-size: 1.3em;">
                        Vous souhaitez assister FANUKIN, contactez-nous au numéro ci-après <br>
                        <a style="color: #2c3c93;" href="tel:+243819956364">+243 819956364</a>
                    </p>
                </div>
            </div>
        </section>
