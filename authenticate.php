                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="irs-account-col">
                            ...
                            <a style="margin-bottom: 30px;" class="btn btn-default irs-big-btn" href="assets/pdf/FICHE-ADHESION-FANUKIN.pdf">
                            ...
                            <form action="inscrits/models/call/candidat/signup" method="post" novalidate="novalidate">
                                ...
                                <input id="email" name="email" class="form-control" placeholder="Adresse email*" required="required" type="email" />

                                <input id="phone" name="phone" class="form-control" placeholder="Numéro de telephone*" required="required" type="text" />

                                <input id="phone" name="ville" class="form-control" placeholder="Ville & Pays de résidence*" required="required" type="text" />

                                <input id="phone" name="faculte" class="form-control" placeholder="Faculté (Filière de formation)*" required="required" type="text" />

                                <input id="phone" name="annee" class="form-control" placeholder="Année d'obtention du diplôme*" required="required" type="text" />

                                <select class="form-control" required name="niveau">
                                    <option value="">Choisir Niveau</option>
                                    <option value="Graduat ">Graduat </option>
                                    <option value="Licence ">Licence </option>
                                    <option value="DEA/DES">DEA/DES</option>
                                    <option value="Thèse de Doctorat">Thèse de Doctorat</option>
                                </select>

                                <textarea class="mb-3" style="width: 100%;margin-bottom: 20px;" name="adresse" placeholder="Adresse physique" required rows="5"></textarea>

                                <input id="password" name="password" class="form-control" placeholder="Mot de passe*" required="required" type="password" />

                                <input id="confirmpassword" name="confirmpassword" class="form-control" placeholder="Confirmation mot de passe*" required="required" type="password" />

                                <button class="btn btn-default irs-big-btn" type="submit">S'inscrire</button>
