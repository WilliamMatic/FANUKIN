...
<html lang="en">
    <head>
        ...
        <!-- Efinance Title -->
        <title>FANUKIN - Détail de l'inscrit</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="irs-inner-heading">
                            ...
                            <p><a href="home">Acceuil</a> > <a href="#">Inscrit</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="irs-teacher-single-field">
            <div class="container">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <div class="irs-teacher-single-col">
                            <div class="irs-teacher-biography">
                                <ul>
                                    <li><strong>Nom complet : </strong> Rosi Jqulin</li>
                                    <li><strong>Secteur d'activité : </strong> math</li>
                                    <li><strong>Experience pro. : </strong> 8 ans</li>
                                    <li><strong>Niveau d'étude :</strong> Licence</li>
                                    <!-- <li>
                ...
                <div class="row irs-other-teachers">
                    <div class="col-md-12">
                        <h3>d'autres inscrits</h3>
                        <div class="row">
                            <div class="row animatedParent animateOnce">
                                <div class="col-md-3 col-sm-6">
                                    <div class="irs-teachers-col animated fadeInUpShort slow delay-250 go">
                                        <a href="inscrit-1"><img src="assets/images/teachers/1.jpg" alt="" /> </a>
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="irs-teachers-col animated fadeInUpShort slow delay-500 go">
                                        <a href="inscrit-1"><img src="assets/images/teachers/2.jpg" alt="" /> </a>
                                        <div class="irs-teachers-name">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="irs-teachers-col animated fadeInUpShort slow delay-750 go">
                                        <a href="inscrit-1"><img src="assets/images/teachers/3.jpg" alt="" /> </a>
                                        <div class="irs-teachers-name">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="irs-teachers-col animated fadeInUpShort slow delay-1000 go">
                                        <a href="inscrit-1"><img src="assets/images/teachers/4.jpg" alt="" /> </a>
                                        <div class="irs-teachers-name">
