    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="card-title mb-0">Notre galérie</h5>
                                    ...
                                    <div class="card-body">
                                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th data-ordering="false">Photos</th>
                                                    <th data-ordering="false">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php  
                                                    require 'models/galerie.php';
                                                    while ($res = $req->fetch(PDO::FETCH_OBJ)) {
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <a href="assets/gallerie/<?= $res->img ?>">
                                                                <?= $res->img ?>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a href="models/delete-galerie.php?id=<?= $res->id ?>">
        ...
        <div class="modal fade" id="dépôts" tabindex="-1" aria-labelledby="varyingcontentModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form method="POST" action="models/add-pictures.php" enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="varyingcontentModalLabel">Ajouter des images</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="cover" required name="files[]" required="" accept=".png,.PNG, .jpg, .jpeg, .JPG, .JPEG, .webp, .wepb" multiple="" />
                            </div>
