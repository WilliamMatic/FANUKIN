                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="card-title mb-0">Les formulaires envoyés</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <a href="<?= $res->file_name ?>">
                                                                <?= substr($res->file_name, 12) ?>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                <?php }$req->closeCursor(); ?>
