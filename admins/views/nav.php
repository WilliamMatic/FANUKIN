<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="dashboard" class="logo logo-dark" style="font-size: 2em;">
            <!-- <span class="logo-sm">
                <img src="assets/images/logo-fanukin.png" alt="" height="65" />
            </span>
            <span class="logo-lg">
                <img src="assets/images/logo-fanukin.png" alt="" height="65" />
            </span> -->
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <!-- end Dashboard Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="follow">
                        <i class="fa-solid fa-user-plus"></i> <span data-key="t-apps">Abonnées</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="alumnis">
                        <i class="fa-regular fa-user"></i> <span data-key="t-landing">
                            Les alumnis
                        </span>
                    </a>
                </li>
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link menu-link" href="country">
                        <i class="fa-solid fa-globe"></i> <span data-key="t-advance-ui">
                            Pays
                        </span>
                    </a>
                </li> -->
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="contracts">
                        <i class="ri-file-list-3-line"></i> <span data-key="t-forms">
                            Contrats
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="studylevel">
                        <i class="fa-solid fa-file-contract"></i> <span data-key="t-tables">Niv. étude</span>
                    </a>
                </li>
