                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="irs-inner-heading">
                            ...
                            <p><a href="home">Acceuil</a> > <a href="#">Contact</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="irs-contact-col">
                            <div class="row">
                                <form id="productForm" action="" method="post">
                                    ...
                                    <div class="col-md-6">
                                        <input id="form_phone" name="form_phone" class="form-control" placeholder="Numéro de telephone*" required="required" data-error="Email is required." type="text" />
                                    </div>
                                    <div class="col-md-12">
                                        <input id="form_subject" name="form_subject" class="form-control" placeholder="Sujet*" required="required" data-error="Subject is required." type="text" />
                                    </div>
                                    <div class="col-md-12">
                                        <textarea id="form_message" name="form_message" class="form-control irs-textarea" rows="12" placeholder="Message*" required="required" data-error="Message is required."></textarea>
                                        <button class="btn btn-default irs-big-btn" type="submit">Envoyer</button>
                                    </div>
                                </form>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="irs-address-col">
                            ...
                            <p>+243 - 81 99 56 364</p>
                        </div>
                        <div class="irs-address-col">
                            <i class="icofont icofont-email"></i>
                            <p>Mail: asblfanukin@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
