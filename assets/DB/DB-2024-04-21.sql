...
INSERT INTO `tb_abonne` (`id`, `email`, `dateabonnement`, `status`) VALUES
	(1, 'willyam@gmail.com', '2024-04-19', 0);
...
INSERT INTO `tb_astuce` (`id`, `titre`, `secteur`, `contenue`, `admin`, `datepublish`, `avatar`, `status`) VALUES
	(1, 'Kylian Mbappé avait promis de prolonger au PSG !', 8, '<p>Cela ne fait plus aucun doute. <a href="https://www.footmercato.net/joueur/kylian-mbappe/">Kylian Mbappé</a> va poursuivre sa carrière en Espagne, du côté du Real Madrid. Lié jusqu’en juin prochain avec les champions de France en titre, l’attaquant parisien tentera, avant cela, de mener les Rouge et Bleu vers un premier sacre historique en Ligue des Champions. Si nous vous révélions, le 7 janvier dernier, que le Bondynois avait finalement donné son accord pour rallier la capitale espagnole, ce bouillant dossier a pourtant connu quelques rebondissements. Ainsi, selon nos dernières informations, l’international tricolore (77 sélections, 46 buts) avait, dans un premier temps, promis de prolonger avec l’écurie parisienne.</p>', 2, '2024-04-20', '583_66240d82af421.webp', 1),
	(2, 'La gestion du calendrier met la Ligue 1 sens dessus dessous !', 8, '<p><i>«Dans l’optique de favoriser le parcours des clubs français en Coupes d’Europe considérant que l’amélioration de l’indice UEFA de la France demeure un objectif essentiel, le Conseil d’Administration de la LFP a décidé ce vendredi 19 avril 2024 d’aménager le calendrier des deux clubs qualifiés en demi-finales de finale de Ligue des Champions (Paris Saint-Germain) et de Ligue Europa (Olympique de Marseille) et de les mettre ainsi dans les meilleures dispositions en vue des demi-finales»</i>. Par le biais d’un communiqué, la Ligue de Football Professionnel, qui avait déjà opté pour ce réaménagement à l’occasion des quarts de finale des différentes Coupes d’Europe, a officialisé le report des matches du PSG, qualifié pour les demi-finales de la Ligue des Champions, et de l’Olympique de Marseille, présent dans le dernier carré de la Ligue Europa. Une décision ne manquant pas de faire réagir les différents clubs de l’élite du football français.</p>', 2, '2024-04-20', '195_66240e28a9180.webp', 1);
...
-- Listage des données de la table fanukin.tb_candidat : ~0 rows (environ)
...
INSERT INTO `tb_contact` (`id`, `nom`, `email`, `sujet`, `phone`, `message`, `status`) VALUES
	(1, 'Will', NULL, 'Xxxxxxxx', '0811552166', 'Xxxxxxxx', 1);
...
-- Listage des données de la table fanukin.tb_message : ~4 rows (environ)
INSERT INTO `tb_message` (`id`, `sujet`, `nom`, `email`, `telephone`, `message`, `status`) VALUES
	...
	(6, 'xx', 'Will', NULL, '0811552166', 'cc', 0);
...
-- Listage des données de la table fanukin.tb_secteur : ~0 rows (environ)
