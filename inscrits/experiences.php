...
>
    <head>
        <meta charset="utf-8" />
        <title>Mes experiences | Mwinda Holding - Sous-traitance d'excellence, résultats probants</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="card-title mb-0">Mes experiences</h5>
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#dépôts">AJOUTER</button>
                                    </div>
                                    <div class="card-body">
                                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle dataTable no-footer dtr-inline collapsed" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-ordering="false">Année</th>
                                                    <th data-ordering="false">Ville - Pays</th>
        ...
        <div class="modal fade" id="dépôts" tabindex="-1" aria-labelledby="varyingcontentModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form method="POST" action="models/new-admin.php">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="varyingcontentModalLabel">Ajouter experience</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="annee-name" class="col-form-label">Anneé</label>
                                <input type="text" placeholder="20XX-20XX" class="form-control" name="annee" id="annee-name" required />
                            </div>

                            <div class="mb-3">
                                <label for="lieu-name" class="col-form-label">Ville, Pays</label>
                                <input type="text" placeholder="ville, pays" class="form-control" name="lieu" id="lieu-name" required />
                            </div>

                            <div class="mb-3">
                                <label for="description" class="col-form-label">Description</label>
                                <textarea class="form-control" required rows="6" name="description" id="description"></textarea>
                            </div>
